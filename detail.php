...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item text-dark" href="#">produk</a>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div>
                        <div>
                            <img class="w-100 h-100" src="image/<?php echo $produk['foto']; ?>" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <p class="mb-4">Digital Alliance N30S Tempered Glass Mid-Tower Gaming Case I DA N3S WHITE-BLACK</p>
    ...
    <div class="container py-4 bg-light">
        <div class="container">
            <h2 class="text-center text-black mb-5">Produk Terkait</h2>
            <div class="row">
                <?php while($data = mysqli_fetch_array($queryProdukTerkait)){ ?>
                <div class="col-md-6 col-lg-3 mb-3">
                    <a href="detail.php?nama=<?php echo $data['nama']; ?>">
